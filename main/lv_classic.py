...
#A = -np.array([[1, 1.09, 1.52, 0], [0, 1, 0.44, 1.36], [2.33, 0, 1, 0.47], [1.21, 0.51, 0.35, 1]])
print(A)

Avals, Avecs = np.linalg.eig(A)
print('max eig A:', np.max(np.real(Avals)))

r = 1.5*np.random.uniform(0.5, 2, n)
#r = [1, 0.72, 1.53, 1.27]
...
print('mean eigenvalue:', np.mean(Jvals))
print('mean final abundance:', np.mean(xf_an))
