...
Aseed = 87      # seed to set A, for same interaction matrix each run 
...
LEcalctime= 100        # time to calculate LEs 
warmuptime = 50        # time to warm up ONS 

LEtime = LEcalctime + warmuptime
ds = 1     # ONS interval in LE Calculation 
nLEs = 5        # number of LEs to calculate 
