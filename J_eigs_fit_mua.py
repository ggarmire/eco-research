...
f = 1.5
g = 1
muas = np.linspace(-0.9, -0.1, length)
muc = -0.5
...
df = pd.DataFrame({'mua': muas, 'mean': means, 'sigma2': sigma2s})

df.to_csv('J_fit_data_mua.csv', index = False)
